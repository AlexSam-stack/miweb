    ...
    this.fileStructure = {
      ...
      "/cuaderno/semana1": {
        ...
        content: {
          ...
          exercise:
            "Identifica y explica la diferencia entre sitio web, página web y aplicación web. Realiza un “Hola Mundo” en HTML y CSS en VS Code.",
...
<!-- ...otros ejemplos... */`,
          description: `
                    ...
                    `,
          reflection:
            "Comprendí la diferencia entre los conceptos web y cómo se conectan los distintos roles y tecnologías para crear experiencias digitales.",
        },
      },
      // ...existing code...
      "/cuaderno/semana2": {
        ...
        content: {
          ...
          exercise:
            "Crea una página sencilla con estructura HTML5, aplica estilos con Flexbox y hazla responsiva usando CSS. Incluye ejemplos de código Emmet.",
...
`,
        ...
        `,
          reflection:
            "Aprendí a estructurar páginas web modernas y responsivas usando HTML5 y CSS3, aplicando Flexbox, principios de diseño fluido y productividad con Emmet.",
        },
      },
      // ...existing code...
      "/cuaderno/semana3": {
        ...
        content: {
          ...
          exercise:
            "Desarrolla una página sencilla usando Bootstrap o Tailwind CSS que incluya una cabecera, botones, una lista y un formulario.",
...
<!-- Puedes cambiar Bootstrap por Tailwind CSS si lo prefieres -->`,
          description: `
                    ...
                    `,
          reflection:
            "Aprendí a utilizar frameworks CSS como Bootstrap y Tailwind para crear interfaces modernas y responsivas de manera eficiente.",
        },
      },
      "/cuaderno/semana4": {
        type: "file",
        content: {
          ...
          exercise:
            "Desarrolla una animación sencilla utilizando JavaScript y el elemento Canvas.",
...
`,
          reflection:
            "Aprendí a manipular el DOM y Canvas con JavaScript, creando animaciones y comprendiendo la interacción entre código y elementos visuales.",
        },
      },
      ...
      "/cuaderno/semana5": {
        ...
        content: {
          ...
          exercise:
            "Implementa el paso de datos entre componentes utilizando props y children en un framework JS.",
...
`,
        ...
        `,
          reflection:
            "Aprendí a crear componentes reutilizables, pasar datos y funciones como props, y a usar children para estructurar interfaces dinámicas en React.",
        },
      },
      // ...existing code...
      ...
      "/cuaderno/semana6": {
        ...
        content: {
          ...
          exercise:
            "Implementa una lista dinámica que obtenga datos de una API externa y permita filtrar resultados mediante un formulario.",
...
`,
        ...
        `,
          reflection:
            "Aprendí a consumir APIs externas, manejar eventos y renderizar listas dinámicas en React usando datos obtenidos de manera asíncrona.",
        },
      },
      // ...existing code...
      // ...existing code...
      "/cuaderno/semana7": {
        ...
        content: {
          ...
          exercise:
            "Implementa un contador con React usando useState y un hook personalizado para registrar el historial de cambios.",
...
`,
        ...
        `,
          reflection:
            "Aprendí a gestionar el estado en React usando hooks fundamentales y personalizados, y a registrar el historial de cambios de estado.",
        },
      },
      // ...existing code...
  ...
  executeCommand(input) {
    ...
    switch (cmd) {
      ...
      default:
        return cmd
          ? [
              `${cmd}: comando no encontrado. Escribe 'help' para ver comandos disponibles.`,
            ]
          : [];
    }
  }
  ...
  changeDirectory(path) {
    ...
    if (
      this.fileStructure[newPath] &&
      this.fileStructure[newPath].type === "directory"
    ) {
                ...
                <div class="section">
                    <div class="code-section">
                        <div class="code-header">
                            ...
                            <button class="copy-button" onclick="portfolio.copyCode('${btoa(
                              content.code
                            )}')">
                                📋 Copiar
                            </button>
